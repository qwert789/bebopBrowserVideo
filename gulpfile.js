...
gulp.task('broadway', function() {
    return gulp.src('Broadway/Player/Decoder.js')
        .pipe(gulp.dest('dist/scripts'))
});
...
// Watch
gulp.task('watch', ['html', 'broadway', 'fonts', 'bundle'], function() {
...
// Build
gulp.task('build', ['html', 'broadway', 'buildBundle', 'images', 'fonts', 'extras'], function() {
